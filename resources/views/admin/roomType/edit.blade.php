            ...
            <div class="col-lg-8">
                <form action="{{route('roomtype.update',$roomType->id)}}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="title" id="" class="form-control" placeholder="Title" value="{{$roomType->title}}">
                     @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="detels" id="detels" cols="6"  class="form-control">{{$roomType->detels}}</textarea>
                        @error('detels')
                        <p class="text-danger mt-2">{{$message}}</p>  
                      @enderror
                      </div>
